...
depends=('runit' 'runit-services>=1.1.0' 'ngetty' 'sysvinit' 'sysvinit-tools-adds')
optdepends=('socklog: advanced logging system' 
...
md5sums=('e8975ebe1661230f6efb0406031d960f')
